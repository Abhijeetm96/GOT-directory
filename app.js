...
var countDownDate = new Date("April 15, 2019 15:30:00").getTime();
...
text.innerHTML = days + " Days " + hours + " Hour "+ minutes + " Min "+ seconds + " Sec ";
clock.innerHTML= days + " Days " + hours + " Hour "+ minutes + " Min "+ seconds + " Sec ";
